...
class CompressTest {
    ...
    @Test
    fun withUTF8Characters() = withDefer {
        // Given
        val (stdOut, stdErr) = captureStreams()
        val tempFile = usingTempFile(
            content = byteArrayOf(
